...
from models import dnn, deepfm, dnn_pool, din, deepfm_pool, dinfm, dien, dnn_autoint
...
class ModelParams:
    def __init__(self):
        ...
        self.autoint_layer_num = int(sys.argv[14])
        self.autoint_emb_size = int(sys.argv[15])
        self.autoint_head_num = int(sys.argv[16])
        self.autoint_use_res = int(sys.argv[17])
